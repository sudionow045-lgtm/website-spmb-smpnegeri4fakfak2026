...
const GAS_WEB_APP_URL = "https://script.google.com/macros/s/AKfycbwz8H_GQCcmfUI-MT8VUPlTfv9o5kIfVepPCeBU0fRzZ7kusDuJFVaTC3n_riuX8l9w/exec";
...
export const getInitialMockSettings = (): AppSettings => {
  const defaultSettings: AppSettings = {
    ...
    formFields: [
      ...
      { id: "header_alamat", label: "DATA ALAMAT", type: "header", required: false },
      ...
      { id: "header_periodik", label: "DATA PERIODIK", type: "header", required: false },
